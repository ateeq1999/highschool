...
<html lang="en" data-textdirection="rtl" class="loading">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{ url('app-assets/images/logo/144.png') }}">
        <link rel="shortcut icon" type="image/png" href="{{ url('app-assets/images/logo/20.png') }}">
    ...
    <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
        ...
        <footer class="footer footer-static footer-light navbar-border">
            <p class="clearfix text-muted text-sm-center mb-0 px-2">
                <span class="float-md-left d-xs-block d-md-inline-block">تاريخ النشر  &copy; 2019  </span>
                <span class="float-md-right d-xs-block d-md-inline-block">كل الحقوق محفوظة ل <a href="https://www.adamoxy.com" target="_blank" class="text-bold-800 grey darken-2">Adamoxy & fatoha </a>
                </span>
            </p>
        </footer>
