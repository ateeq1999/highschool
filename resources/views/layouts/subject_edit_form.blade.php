                        ...
                        <div class="col-md-12">
                            <div class="card" style="">
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <form action="/subject/{{ $subject->id }}" class="form" method="POST">
                                            @method('PATCH')
                                            @csrf
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ old('name') ?? $subject->name }}" type="text" id="name" class="form-control" placeholder="اسم المادة  " name="name">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="studay_year" name="studay_year" class="form-control">
                                                                @if ($subject->studay_year == 'الاولى')
                                                                    <option selected value="الاولى">الاولى</option>
                                                                    <option value="الثانيه">الثانيه</option>
                                                                    <option value="الثالثه">الثالثه</option>
                                                                @else
                                                                    @if ($subject->studay_year == 'الثانيه')
                                                                        <option value="الاولى">الاولى</option>
                                                                        <option selected value="الثانيه">الثانيه</option>
                                                                        <option value="الثالثه">الثالثه</option>
                                                                    @else
                                                                        <option value="الاولى">الاولى</option>
                                                                        <option value="الثانيه">الثانيه</option>
                                                                        <option selected value="الثالثه">الثالثه</option>
                                                                    @endif
                                                                @endif
                                                            </select>
                                                        </div>
