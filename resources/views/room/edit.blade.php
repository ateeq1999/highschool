                          ...
                          <div class="col-md-12">
                                  <div class="card" style="">
                                      ...
                                      <div class="card-body collapse in">
                                          <div class="card-block">
                                              <form action="/room/{{ $room->id }}" class="form" method="POST">
                                                @csrf
                                                @method('PATCH')
                                                  <div class="form-body">
                                                      <div class="row">
                                                          <div class="col-md-12">
                                                              <div class="form-group">
                                                                  ...
                                                                  <input value="{{ $room->name }}" type="text" id="name" class="form-control" placeholder="اسم الفصل " name="name">
                                                              </div>
                                                          </div>
                                                      </div>
                                                                  ...
                                                                  <select id="year" name="year" class="form-control">
                                                                      ...
                                                                      @else
                                                                         @if ($room->year = 'الثاني')
                                                                            ...
                                                                            <option selected value="الثاني">الثاني</option>
                                                                            <option value="الثالث">الثالث</option>
                                                                         @else
                                                                            <option value="الاول">الاول</option>
                                                                            <option value="الثاني">الثاني</option>
                                                                            <option selected value="الثالث">الثالث</option>
                                                                         @endif 
                                                                      @endif
                                                                  </select>
                                                              </div>
